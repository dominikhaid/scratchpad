...
import SysMsg from '@/components/msg/SysMsg';
...
export default function Login(props) {
  ...
  return !props.userAuth.userData.uid ? (
    <>
      <Head>
        <title>Print & Screen-Design | Login</title>
        <meta
          name="description"
          content="Zugang zu Privaten Bereich von Dominik Haid, Print & Screen-Design Registrierung oder Login zu Privaten oder geteilten Inhalten."
        />
      </Head>
      <Container className="material-grid flex-center min-height">
        <div className="material-grid__col--medium--2 material-grid__col--xsamll--0 flex-center"></div>
        <Segment className={'material-grid__col--medium--7 flex-center'}>
  ...
  //return <LoginForm userAuth={props.userAuth} />
}
